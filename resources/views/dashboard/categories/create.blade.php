...
<section id="add-meme">
    ...
    <form action="/dashboard/categories" method="post">
        ...
        <div class="py-4">
            <div class="py-2">
                <label for="name" class="text-justify">Category</label>
                <div class="flex items-center border-b border-gray-300 py-2">
                    <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" id="name" name="name" placeholder="Nama kategori" required autofocus />
                    @error('category')
            ...
            <div class="py-2">
                <label for="slug" class="text-justify">Link <span class="text-gray-700 text-xs">(Otomatis terisi, ubah bila perlu)</span></label>
                <div class="flex items-center border-b border-gray-300 py-2">
