...
<div>
    ...
    <section id="content">
        ...
        <div class="flex py-4 gap-5">
            <div class="flex px-4 bg-[#B7EB38] rounded-full">
                <button class="">
                    <div class="">
            ...
            <div class="flex px-4 bg-[#B7EB38] rounded-full">
                ...
                <p class="px-2 py-2">Delete post</p>
            </div>
        </div>
        <div class="md:flex flex-col shadow-2xl w-full h-full">
            ...
            <div class="bg-white rounded-br-full px-10 py-6 md:py-9 w-full">
                ...
                <div class="md:py-6 py-4 md:px-6 flex justify-between">
                    <div>
                        <button class="">
