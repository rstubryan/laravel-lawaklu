        ...
        <div class="w-full max-w-xs">
          <form class="bg-white shadow-2xl rounded px-8 pt-6 pb-8 mb-4" method="post">
            ...
            <div class="mb-2">
              ...
              <input class="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="name" type="name" placeholder="John Doe" />
            </div>
            <div class="mb-6">
