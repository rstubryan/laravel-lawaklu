    ...
    <div class="py-2">
      <form class="w-full">
        ...
        <div class="flex items-center border-b border-gray-300 py-2">
          <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Deskripsikan meme-mu" aria-label="Full name" />
        </div>
      </form>
    </div>
    <div class="py-2">
