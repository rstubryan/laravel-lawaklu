...
<div>
  <section id="content">
    ...
    <div data-aos="fade-up" data-aos-offset="50" data-aos-delay="50" data-aos-duration="700" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" data-aos-anchor-placement="top-center">
      <div class="md:flex shadow-2xl w-full h-full">
        ...
        <div class="bg-white rounded-br-full px-10 py-6 md:py-9 w-full">
          <div class="md:px-6 py-3">
            ...
            <div class="md:py-6 py-4 flex justify-between">
              <div>
                <button class="">
