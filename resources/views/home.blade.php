  ...
  <section id="content">
        ...
        <div class="md:px-6 py-3">
          <div class="py-2">
            <div class="flex justify-between rounded-full">
              <p class="flex font-semibold py-2 pr-2">4 Likes</p>
              <div class="flex">
                <img src="https://placehold.co/40x40" class="rounded-full flex" />
                <p class="flex py-2 px-2">Nama user</p>
              </div>
            </div>
          </div>
          <p class="text-justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Possimus, eius ut vel corrupti veniam dolores distinctio,
            similique minima, eos repellendus iste? Alias sed fugit
            tempore veritatis facere sit odit rerum?
          </p>
        </div>
        <div class="py-2">
    ...
    <div class="md:flex shadow-2xl w-full h-full">
      ...
      <div class="bg-white rounded-br-full px-10 py-6 md:py-9 w-full">
        ...
        <div class="md:px-6 py-3">
          <h3 class="font-semibold">4 Likes</h3>
          <p class="text-justify">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Possimus, eius ut vel corrupti veniam dolores distinctio,
            similique minima, eos repellendus iste? Alias sed fugit
          ...
          <p class="text-justify text-gray-400">View all comments</p>
          <form class="w-full" method="post">
            <div class="flex items-center border-b border-gray-300 py-2">
              <div class="rounded-full">
                <img src="https://placehold.co/40x40" class="rounded-full" />
              </div>
              <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Add a comment" aria-label="Full name" />
